...
#define SMEM_MAX						12
//情報を参照するためのキー
#define SMEM_CRANE_STATUS_ID			0
#define SMEM_SWAY_STATUS_ID				1
#define SMEM_OPERATION_STATUS_ID		2
#define SMEM_FAULT_STATUS_ID			3
#define SMEM_SIMULATION_STATUS_ID		4
#define SMEM_PLC_IO_ID					5
#define SMEM_SWAY_IO_ID					6
#define SMEM_REMOTE_IO_ID				7
#define SMEM_JOB_STATUS_ID				8
#define SMEM_COMMAND_STATUS_ID			9
#define SMEM_EXEC_STATUS_ID				10
